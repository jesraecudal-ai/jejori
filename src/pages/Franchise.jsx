      ...
      <div className="py-24 px-6 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="font-serif text-5xl md:text-7xl font-bold text-[#F2F2F2] mb-6">
            Tenha uma Experiência <span className="text-gold">Jejori</span>
          </h1>
      ...
      <div className="max-w-2xl mx-auto px-6 pb-24">
        ...
        >
          ...
          <p className="text-[#F2F2F2]/40 text-sm font-sans text-center mb-8">
            Conte-nos sobre você — entraremos em contato com mais detalhes
          </p>

          {submitted ? (
            <div className="text-center py-10">
              <CheckCircle className="w-12 h-12 text-gold mx-auto mb-4" />
              <h4 className="font-serif text-xl text-[#F2F2F2] mb-2">Obrigado!</h4>
              <p className="text-[#F2F2F2]/50 font-sans text-sm">
                Nossa equipe de franquias entrará em contato em até 48 horas.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Select onValueChange={(val) => setForm({ ...form, investment_range: val })}>
                ...
                <SelectContent className="bg-[#1a1a1a] border-[#D4AF37]/15">
                  <SelectItem value="under_100k">Até R$ 100K</SelectItem>
              ...
              <Textarea
                placeholder="Conte-nos sobre seu perfil ou visão"
                value={form.message}
